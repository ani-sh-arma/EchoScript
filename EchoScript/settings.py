"""
Django settings for EchoScript project.
...
SECRET_KEY = 'django-insecure-!)tn4i9h4w0k3f8@zi6(yk71r*87-8a+y)y(db*xz14+mdi42v'
...
WSGI_APPLICATION = 'EchoScript.wsgi.application'
